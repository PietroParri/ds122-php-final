...
<html>
  ...
  <body>
    ...
    <div class="alinhamento">
      <h1 class="display-1">Bloggers - Violão</h1>
        <div id="div-70" class="video-principal">
          <iframe width="1250" height="670" src="https://www.youtube.com/embed/tcRrAG2gBvw"
            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay;
              clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
          </iframe>
        </div>
        <div id="div-30" class="primeirop"><br>
            Neste vídeo, eu toco Hurt do Johnny Cash no violão. O violão é um Giannini N-14, devidamente afinado (teoricamente),
            minha transição entre acordes não é boa ainda (principalmente pro ré maior), e pra tocar o segundo verso eu me embaralho um pouco.
            Considerando que toco há um pouco mais de 6 semanas, me sinto satisfeito de já conseguir tocar uma música inteira.
          <p><br>
        <div class="ultimop">
